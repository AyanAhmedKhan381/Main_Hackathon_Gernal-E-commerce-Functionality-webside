      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="overflow-auto">
          <table className="min-w-full border-t border-gray-200">
            <thead>
              <tr>
                <th className="border-r border-gray-300 px-4 py-2 text-left text-lg font-semibold text-gray-700">General</th>
...
export default GernalComparison;